...
export default async function OperationsPage() {
  ...
  return <div className="ops-shell">
    ...
    <nav className="ops-subnav" aria-label="Módulos operativos"><Link href="/operaciones">Mando</Link>{roles.has("event_admin")&&<Link href="/operaciones/centros">Puntos de entrega</Link>}{(roles.has("warehouse_operator")||roles.has("logistics_operator")||roles.has("event_admin"))&&<Link href="/operaciones/bodega">Bodega y logística</Link>}{(roles.has("treasury_requester")||roles.has("treasury_approver")||roles.has("event_admin")||roles.has("auditor"))&&<Link href="/operaciones/tesoreria">Tesorería</Link>}</nav>
