...
- Último resultado comprobado: reset reproducible, 68 pruebas SQL, RLS de mapa/logística/tenant/funciones, 9 unitarias, 18 web, lint, typecheck y build verdes.
...
- Bloqueos reales: operador, autoridad, DPIA, política de bienes/datos/evidencias, proveedor real, marcas, protección de contraseñas filtradas y verificación remota Vercel.
...
- Datos: migraciones hasta `202608140009_foreign_key_indexes.sql`; 0 FK públicas sin índice, proyección logística derivada, RLS, privilegios explícitos de funciones y Supabase Realtime.
...
- Resultado: 68 SQL + 1 verificación RLS + 9 unitarias + 18 web; aplicación local sana y Supabase remoto sandbox migrado con fixtures sintéticos. Auditoría detallada en `docs/FUNCTIONAL_AUDIT_2026-08-14.md`.
